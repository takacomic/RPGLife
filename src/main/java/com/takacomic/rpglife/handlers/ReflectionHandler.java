package com.takacomic.rpglife.handlers;
...
public final class ReflectionHandler
{
    ...
    {
        return
                getConstructor(clazz, DataType.convertToPrimitive(args)).newInstance(args);
    }
    ...
    {
        return
                getMethod(instance.getClass(), name, DataType.convertToPrimitive(args)).invoke(instance, args);
    }
    ...
    {
        return
                getMethod(clazz, name, DataType.convertToPrimitive(args)).invoke(instance, args);
    }
    ...
    public static enum PacketType
    {
        ...
        public Class<?> getPacket()
                throws Exception
        {
            return this.packet == null ? (this.packet =
                    ReflectionHandler.getClass(this.name, ReflectionHandler.PackageType.MINECRAFT_SERVER)) :
                    this.packet;
        }
    }
    ...
    public static enum SubPackageType
    {
        ...
        {
            this.name =
                    (PackageType.CRAFTBUKKIT + "." + name().toLowerCase());
        }
